              ...
              T_word16 data2)
{
    ...
    switch(event)  {
        ...
        case UI_EVENT_KEY_BUFFERED:
            ...
            /* a key to insert.  */
            IUITextInsertKeystroke(object, data1) ;
                  ...
                  T_word16 posY)
{
    ...
    p_text->cursorLine = newCursorLine ;
    ...
    if (newCursorLine != oldCursorLine)  {
        ...
        IUITextDrawLine(uiText, oldCursorLine) ;
    }

    /* In either case, the new line must be drawn. */
    IUITextDrawLine(uiText, newCursorLine) ;
                  ...
                  T_word16 cursorIndex)
{
    ...
    p_text->cursorLine = IUITextFindLineNumber(uiText, cursorIndex) ;
    ...
    p_text->cursorIndex = cursorIndex ;
