...
T_void HouseUIStart  (T_word32 formNum)
{
    ...
    for (i=0;i<4;i++)
    {
        ...
        G_financeDisplays[i]=TxtboxCreate(163,
                                          43+(i*11),
                                          203,
                                          52+(i*11),
                                          "FontMedium",
    ...
    G_ownedByDisplay=TxtboxCreate(54,
                                  21,
                                  203,
                                  30,
                                  "FontMedium",
    ...
    G_salePriceDisplay=TxtboxCreate(141,
                                    122,
                                    179,
                                    131,
                                    "FontMedium",
    ...
    if (G_iOwnThisHouse==TRUE)
    {
        ...
        G_actionButton=ButtonCreate(121,
                                    89,
                                    "UI/HOUSE/LEAVE",
                                    FALSE,
                                    0,
...
T_void HouseUIEnd    (T_void)
{
    ...
    if (G_actionButton != NULL) ButtonDelete (G_actionButton);
    if (G_forSaleToggle != NULL) ButtonDelete (G_forSaleToggle);
    if (G_increasePriceButton != NULL) ButtonDelete (G_increasePriceButton);
    if (G_decreasePriceButton != NULL) ButtonDelete (G_decreasePriceButton);
                   ...
                   E_Boolean isOccupied)
{
    ...
    else
    {
        ...
        if (G_iOwnThisHouse==TRUE)
        {
            ...
            G_forSaleToggle=ButtonCreate(134,
                                         109,
                                         "UI/CREATEC/CRC_TOG2",
                                         TRUE,
                                         0,
            ...
            G_increasePriceButton=ButtonCreate (121,
                                                123,
                                                "UI/COMMON/UPARROW",
                                                FALSE,
                                                0,
            ...
            G_decreasePriceButton=ButtonCreate (131,
                                                123,
                                                "UI/COMMON/DNARROW",
                                                FALSE,
                                                0,
...
T_void HouseChangeStatus (T_buttonID buttonID)
{
    ...
    if (buttonID==G_actionButton)
    {
        ...
        {
            /* deduct price */
            StatsChangePlayerTotalCarriedWealth(-G_houseSaleValue*100);
    ...
    else if (buttonID==G_decreasePriceButton)
    {
        if (G_houseIsForSale)
        {
            ...
            else G_houseSaleValue=MIN_HOUSE_SALE_VALUE;
            sprintf (stmp,"%d",G_houseSaleValue);
            TxtboxSetData(G_salePriceDisplay,stmp);
        }
    }
