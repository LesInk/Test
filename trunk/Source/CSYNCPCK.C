...
static T_word16 G_numPlayers = 1 ;
...
//                }
        ...
        case PLAYER_ACTION_MELEE_ATTACK:
            ...
            if (p_target)  {
                ...
                damageInfo.type = p_actionData[1] /* damage type */ ;
        ...
        case PLAYER_ACTION_PICKUP_ITEM:
            ...
            if (isPlayer)  {
                ...
                if (p_target)  {
                    ...
                    if (InventoryTakeItemFromWorld(p_target))  {
...
//            p_syncro->deltaTime = 3 ;
        ...
        //printf("x=%d, y=%d\n", p_syncro->x, p_syncro->y) ;
            ...
            /* Update translucency. */
            p_syncro->stanceAndVisibility = PlayerGetStance() ;
