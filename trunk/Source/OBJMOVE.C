...
*/
        ...
        if (!(ObjMoveStruct->Flags & OBJMOVE_FLAG_DOES_NOT_FLOW))  {
            ...
            if (((p_sectorInfo->type == SECTOR_TYPE_LAVA) ||
                ...
                ObjMoveStruct->XV += (((T_sword32)p_sectorInfo->xVelAdd)<<14) ;
                ObjMoveStruct->YV += (((T_sword32)p_sectorInfo->yVelAdd)<<14) ;
                ObjMoveStruct->ZV += (((T_sword32)p_sectorInfo->zVelAdd)<<10) ;
