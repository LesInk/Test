        ...
        if ((item != NULL) && (InventoryObjectIsInMouseHand() == FALSE))
        {
            ...
            if (InventoryObjectIsInMouseHand()==TRUE)
            {
                ...
                else
                {
                    ...
                    else if (KeyboardGetScanCode(KEY_SCAN_CODE_ALT)==TRUE)
                    {
...
T_inventoryItemStruct* InventoryTakeObject (E_inventoryType which, T_3dObject *item)
{
    ...
    T_byte8 stmp[32];
    T_word16 i,j;
    T_word32 t1,t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,t13,t14,t15,t16;
    T_word32 t17,t18,t19,t20,t21,t22,t23,t24;
    T_word16 weight;
