...
//            GrSetCursorPosition (5,188);
              GrDrawShadowedText ("Shareware Demo V1.0",210,0);
#else
              GrSetCursorPosition (220,188);
//            GrSetCursorPosition (5,188);
...
//#endif
    ...
    GrDrawRectangle(0, 0, SCREEN_SIZE_X-1, SCREEN_SIZE_Y-1, 0) ;
    ColorUpdate(1) ;
    IShowScreen("UI/SCREENS/END1", VIEW_PALETTE_STANDARD, 350) ;
    ColorFadeTo(0,0,0);
    GrDrawRectangle(0, 0, SCREEN_SIZE_X-1, SCREEN_SIZE_Y-1, 0) ;
    ColorUpdate(1) ;
    IShowScreen("UI/SCREENS/END2", VIEW_PALETTE_STANDARD, 350) ;
    ColorFadeTo(0,0,0);
#endif
