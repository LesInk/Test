...
//    OverheadDraw(VIEW3D_CLIP_LEFT, 0, VIEW3D_CLIP_RIGHT-1, VIEW3D_HEIGHT-1) ;
...
T_void ViewUpdatePlayer(T_void)
{
    ...
    T_sword16 floor, floor2, ceiling;
    T_sword16 tempfloorht;
    T_word16 numSectors,j;
    T_word16 *p_sectors;
    T_sword32 xVel, yVel ;
    ...
    */
	        ...
	        if ((flags & 8) == 8)  {
	            if ((PlayerGetZ()>>16) <=
                     G_3dSectorArray[PlayerGetAreaSector()].floorHt)  {
                     PlayerAddExternalVelocity(0, -(delta<<16), 0) ;
